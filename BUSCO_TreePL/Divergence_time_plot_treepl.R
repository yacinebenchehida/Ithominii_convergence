...
annot_tree <- phyloch::read.beast("/Users/yacinebenchehida/Desktop/Convergent_evolution/All_Melinaea/TreePL/New/1_calibrations/Results/treeannotator_results_1_calibrations.txt")
...
pdf("busco_tree_treepl_1_calibrations.pdf",18,10)
geoscalePhylo(ladderize(annot_tree, right = F), x.lim = c(0, 190), cex.tip = 0.6, cex.age = 1, cex.ts = 0.9, units = c("Epoch","Age"),quat.rm=TRUE,width= 2, align.tip.label=FALSE, ftype = "b")
