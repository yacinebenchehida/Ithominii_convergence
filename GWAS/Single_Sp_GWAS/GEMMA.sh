...
#VCF="/users/ybc502/scratch/Conv_Evol/GWAS/Inputs/MultiSpecies/Cydon_Maeolus_Mothone_Marsaeus_merged.vcf.gz"
#VCF="/users/ybc502/scratch/Conv_Evol/GWAS/Inputs/Hypothyris_anastasia/*vcf.gz"
...
#To run: ./GEMMA_multispecies.sh Melinaea_marsaeus multiple_menophilus
