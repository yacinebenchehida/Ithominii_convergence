...
for (sp in dat){
	...
	order_contigs = read.table(paste("/mnt/scratch/projects/biol-specgen-2018/yacine/Conv_Evol/GWAS/Figure_2/Data/scaffold_order_",sp,".txt",sep=""),skip=1)
	...
	print(peak)
	print(bonf_threshold)
	print(gwas_data[gwas_data$CHR==peak & -log10(gwas_data$P) > bonf_threshold,])
...
###########################################
png(file="Cortex_GWAS.png",width=500,height=800,type="cairo")
